...
import { Phone, MessageCircle, ChevronLeft, ChevronRight, Palette, Image, Layout, Award, FileText, Monitor, Megaphone, Film, Package, MapPin } from "lucide-react";

export default function GraphicDesign() {
  // Removed unused state variables

  // Portfolio items - All service categories
      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="relative w-full max-w-5xl mx-auto mb-24 overflow-hidden rounded-2xl shadow-2xl">
          ...
          <div className="text-center mt-8">
            <p className="text-gray-500 text-sm">Interested in seeing more? <a href="#contact" className="text-[#f73002] hover:underline">Contact Us Now</a> for a full portfolio review.</p>
          </div>
        </div>
      </div>
    );
